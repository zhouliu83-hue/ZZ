...
name: zz-diagnosis
description: |
  周正商业 商业模式诊断。两种模式：问诊（消解你的问题）和体检（拆解你的商业模式）。
  触发方式：/zz-diagnosis、/周正问诊、「帮我看看商业模式」「诊断一下我的业务」「我有个商业问题」
  Business model diagnosis. Two modes: consultation (dissolve your question) and checkup (analyze your business model).
  Trigger: /zz-diagnosis, "diagnose my business model", "I have a business question"
---
...
→ 告诉用户：**「这不是一个商业问题，这是一个情绪问题。我的业务边界是商业诊断。」**
